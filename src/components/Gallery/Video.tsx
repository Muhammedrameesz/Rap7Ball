...
const VideoSection = () => {
  return (
    ...
    >
      <h2
        className="text-sm md:text-xl lg:text-3xl font-medium md:font-semibold text-gray-800 bg-black/50 shadow-custom w-fit mx-auto px-6 py-2 
      ...
      <motion.div
        ...
        className="max-w-4xl mx-auto text-center bg-white shadow-newNormal rounded-3xl p-2 md:p-10"
      >
